...
namespace App\Http\Controllers\Settings\Pricing;
...
class SettingsPricingController extends Controller {
	...
	public function index(Request $request) {
        ...
        return view('settings.pricing.index', ['settings' => $settings]);
    }
    ...
    public function store(Request $request) {
		...
		return redirect()->route('settings.pricing.index')->with('success', 'Settings saved');
    }
}