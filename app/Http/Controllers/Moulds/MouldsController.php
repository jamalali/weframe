...
namespace App\Http\Controllers\Moulds;
...
class MouldsController extends Controller {
    ...
    public function index() {
        ...
        return view('moulds.index', [
            'glazing_options' => $glazing_options
        ]);
    }
	
    public function create() {
        return view('moulds.create', [
			'glazing' => null
		]);
    }
    ...
    public function store(StoreUpdateGlazing $request) {
        ...
        return redirect()->route('moulds.index')->with('success', 'New Glazing option added');
    }
    ...
    public function edit(Request $request, Glazing $glazing) {
        return view('moulds.edit', ['glazing' => $glazing]);
    }
    ...
    public function update(StoreUpdateGlazing $request, Glazing $glazing) {
        ...
        return redirect()->route('moulds.index')->with('success', 'Glazing updated');
    }
    ...
    public function destroy(Glazing $glazing) {
        ...
        return redirect()->route('moulds.index')->with('success', 'Group deleted');
    }
}